...
def run_game(game_parameters):
  ...
  players_number = game_parameters['players']

  #PLAYER DEFINITION

  #players = [RandomAgent(game_parameters) for k in range(players_number)]
  players = [RedRanger(game_parameters) for k in range(players_number)]
...
if __name__ == "__main__":
  ...
  run_game({"players": 3, "random_start_player": True, "colors":5, "ranks":5}) #, "hand_size":5
